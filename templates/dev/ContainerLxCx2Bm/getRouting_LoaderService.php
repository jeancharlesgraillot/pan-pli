...
include_once \dirname(__DIR__, 4).'/vendor/symfony/routing/Loader/ObjectRouteLoader.php';
include_once \dirname(__DIR__, 4).'/vendor/symfony/routing/Loader/DependencyInjection/ServiceRouterLoader.php';
...
$b = new \Symfony\Component\HttpKernel\Config\FileLocator(($this->services['kernel'] ?? $this->get('kernel', 1)), (\dirname(__DIR__, 4).'/src/Resources'), [0 => (\dirname(__DIR__, 4).'/src')]);
