...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'App\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'picture', '' . "\0" . 'App\\Entity\\User' . "\0" . 'hash', '' . "\0" . 'App\\Entity\\User' . "\0" . 'passwordConfirm', '' . "\0" . 'App\\Entity\\User' . "\0" . 'userRoles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'articles'];
        }
    ...
    public function setPasswordConfirm($passwordConfirm)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPasswordConfirm', [$passwordConfirm]);

        return parent::setPasswordConfirm($passwordConfirm);
    }
